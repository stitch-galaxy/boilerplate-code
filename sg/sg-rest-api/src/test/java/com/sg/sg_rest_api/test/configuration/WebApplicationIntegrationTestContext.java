...
@Configuration
@EnableWebMvc
@Import({TestRestPropertiesContextConfiguration.class, ValidatorContext.class, ServiceMockContext.class, SgCryptoContext.class, JacksonMapperContext.class, SecurityContext.class, MailMockContext.class})
