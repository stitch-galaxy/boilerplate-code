...
public class RequestPath {
    ...
    public static final String REQUEST_THREAD_LIST = REST_PATH + "/threads";
    ...
    public static final String REQUEST_CANVAS_LIST = REST_PATH + "/canvases";
    public static final String REQUEST_CANVAS_UPDATE = REST_SECURE_ADMIN_PATH + "/canvas/update";
    
    public static final String REQUEST_SIGNIN = REST_PATH + "/signin";
    public static final String REQUEST_SIGNUP_USER = REST_PATH + "user/signup";
    public static final String REQUEST_SIGNUP_ADMIN_USER = REST_SECURE_ADMIN_PATH + "admin/signup";
    public static final String REQUEST_VERIFY_USER = REST_PATH + "user/verify";
    public static final String REQUEST_RESET_PASSWORD = REST_PATH + "user/password/reset";
