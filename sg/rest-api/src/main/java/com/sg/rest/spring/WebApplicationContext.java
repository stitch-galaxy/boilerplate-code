...
@Configuration
@Import({PropertiesContextConfiguration.class, PersistenceContextConfig.class, ServiceContextConfig.class, WebTokenServiceContextConfiguration.class, JacksonMapperContext.class, SecurityContext.class, SgMailServiceContext.class})
