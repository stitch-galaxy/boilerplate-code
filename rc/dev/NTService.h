...
class CNTService {
	...
	protected:	// data members
		...
		char			m_szStartName[255];			// default: ""
		char			m_szPassword[255];			// default: ""


	public:		// construction/destruction
			// If <DisplayName> is not set, then it defaults to <ServiceName>.
		CNTService(LPCTSTR ServiceFileName, LPCTSTR ServiceName, LPCTSTR DisplayName = 0);
		~CNTService();

		char			m_szCurrentStatus[255];		// default "STOPPED"
	...
	public:		// overridables
		...
		virtual void	Shutdown();
			...
			//		arguments !
		virtual BOOL	RegisterService(LPTSTR lpszCommpandLine);
		...
		virtual BOOL	DebugService(BOOL faceless=FALSE);	//!! TCW MOD - added FACELESS parm to allow Win95 usage.
	...
	public:	// helpers
		...
		virtual void	AddToMessageLog(LPTSTR	Message, WORD	EventType = EVENTLOG_ERROR_TYPE, DWORD	dwEventID = DWORD(-1));
		void FormatLogMessage(WORD wEventType, char *szFormat, ... );
