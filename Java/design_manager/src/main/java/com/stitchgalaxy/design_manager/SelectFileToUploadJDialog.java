 ...
 * @author tarasev
 */
public class SelectFileToUploadJDialog extends javax.swing.JDialog
{

    /** Creates new form SelectLanguageJDialog */
    public SelectFileToUploadJDialog(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(SelectFileToUploadJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                SelectFileToUploadJDialog dialog = new SelectFileToUploadJDialog(new javax.swing.JFrame(), true);
