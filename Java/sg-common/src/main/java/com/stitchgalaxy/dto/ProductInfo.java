...
import com.stitchgalaxy.domain.*;
...
public class ProductInfo {
    ...
    private PartnerInfo author;
    private PartnerInfo translator;
    private Long sales;
    private Long rating;
    private Long rates;
    ...
    private String tags;
    private final Set<ProductLocalizationInfo> localizations = new HashSet<ProductLocalizationInfo>();
    private final Set<CategoryInfoDTO> categories = new HashSet<CategoryInfoDTO>();
     ...
     */
    public void setAuthor(PartnerInfo author) {
        this.author = author;
    }
     ...
     */
    public PartnerInfo getTranslator() {
        return translator;
    }
     ...
     */
    public void setTranslator(PartnerInfo translator) {
     ...
     */
    public Set<ProductLocalizationInfo> getLocalizations() {
     ...
     */
    public Set<CategoryInfoDTO> getCategories() {
        return categories;
    }
